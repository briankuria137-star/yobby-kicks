        ...
        return (
          ...
          >
            ...
            <div className="relative aspect-square overflow-hidden bg-gray-100">
              ...
              {/* VIEW ICON */}
              <div className="absolute bottom-3 right-3 flex h-9 w-9 items-center justify-center rounded-full bg-white/95 opacity-0 shadow-sm transition duration-300 group-hover:opacity-100">
