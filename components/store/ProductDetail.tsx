      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-[1.08fr_0.92fr] lg:gap-14">
        ...
        <div>
          <div className="group relative overflow-hidden rounded-[2rem] border border-white/10 bg-surface shadow-[0_30px_100px_rgba(0,0,0,0.35)]">
            ...
            {images.length > 1 && (
              <>
                <button
                  ...
                  className="absolute left-3 top-1/2 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-black/80 shadow-sm"
                >
                  <ArrowLeft className="h-4 w-4" />
                </button>
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-black/80 shadow-sm"
                >
            ...
            {product.stock_quantity > 0 && (
              <div className="absolute left-4 top-4 flex items-center gap-1.5 rounded-full bg-black/90 px-3 py-2 text-[9px] font-bold uppercase tracking-widest text-white shadow-sm backdrop-blur">
            ...
            <div className="mt-4 grid grid-cols-4 gap-2 sm:grid-cols-5">
              {images.map((image, index) => (
                <button
                  ...
                  className={`aspect-square overflow-hidden rounded-xl border border-white/10 bg-surface transition ${
                    index === activeImage
        ...
        <div className="animate-cinematic lg:sticky lg:top-28 lg:pt-3">
          ...
          <div className="mt-5 flex items-end justify-between gap-4 border-b border-white/10 pb-6">
            ...
            <span className="rounded-full bg-white/5 px-3 py-1.5 text-[9px] font-bold uppercase tracking-wide">
          ...
          {whatsappUrl && product.stock_quantity > 0 && (
            <a
              ...
              className="mt-8 flex w-full items-center justify-center gap-2 rounded-full bg-accent px-6 py-4 text-xs font-bold uppercase tracking-widest text-white transition hover:-translate-y-0.5 hover:bg-charcoal hover:shadow-soft"
            >
