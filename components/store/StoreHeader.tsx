...
export function StoreHeader({
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/10 bg-[#09090B]/80 shadow-[0_12px_50px_rgba(0,0,0,0.18)] backdrop-blur-2xl transition-all duration-500">
          ...
          <nav className="hidden items-center gap-9 md:flex">
            {categories.map(([label, category]) => (
              <Link
                ...
                className="group relative py-2 text-[10px] font-black uppercase tracking-[0.18em] text-white/60 transition-colors duration-300 hover:text-white"
              >
                {label}
              </Link>
            ))}
          ...
          <div className="flex items-center gap-2.5">
            ...
            {whatsappUrl && (
              <a
                ...
                className="hidden items-center gap-1.5 rounded-full border border-accent/25 bg-accent px-4.5 py-2.5 text-[9px] font-black uppercase tracking-[0.16em] text-white shadow-[0_10px_30px_rgba(139,92,246,0.18)] transition-all duration-300 hover:-translate-y-0.5 hover:bg-violet-400 hover:shadow-[0_16px_40px_rgba(139,92,246,0.28)] md:flex"
              >
            ...
            <Link
              href="/?category=all"
              className="hidden items-center gap-1.5 rounded-full border border-white/10 bg-white/[0.045] px-4 py-2.5 text-[9px] font-black uppercase tracking-[0.16em] text-white/80 backdrop-blur-xl transition-all duration-300 hover:-translate-y-0.5 hover:border-white/20 hover:bg-white/10 hover:text-white md:flex"
            >
              Shop
            ...
            <button
              ...
              className="rounded-2xl border border-white/10 bg-white/[0.05] p-2.5 text-white/80 shadow-lg backdrop-blur-xl transition-all duration-300 hover:-translate-y-0.5 hover:border-white/20 hover:bg-white/10 hover:text-white md:hidden"
